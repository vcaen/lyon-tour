...
class filter_manager:
    ...
    def getAttractionFiltred(self, liste_jours, preferences_user):
        ...
        for i, elt in liste_jours:
            ...
            listAttractions = executeRequests(10, preferences_filtrees)
            for section in listAttractions:
                for attraction in section:
                    if (attraction in liste_jours[i-1].getAttractions()) and (i>0):
                        section.remove[attraction]
            elt.addAttraction(listAttractions)
        return listAttractions

if __name__=='__main__':
    tour = lyontour.model.tour_manager.Tour('2015-06-04','2015-06-10')
